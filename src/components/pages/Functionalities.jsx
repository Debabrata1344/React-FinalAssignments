...
const Functionalities = () => {
  ...
  // Initial states based on your data
  ...
  return (
    <div className="bg-[#fcfcfc] min-h-screen p-8 font-sans">
      {/* Breadcrumbs */}
      ...
      <button 
        onClick={() => navigate(-1)} 
        className="flex items-center gap-2 text-gray-800 mb-8 group"
      >
      ...
      <div className="space-y-6">
        {/* Available to Select Section (Green) */}
        ...
        {/* Currently Selected Section (Red) */}
        <div className="bg-white rounded-md border border-gray-100 p-6 shadow-sm">
          <div className="flex justify-between items-center mb-6">
            <h3 className="text-sm font-semibold text-gray-700">Select Features</h3>
      ...
      <div className="mt-10 flex justify-end items-center gap-8">
        ...
        <button className="bg-[#8B0000] text-white px-8 py-2 rounded text-sm font-bold shadow-md hover:bg-red-900 transition-colors">
          Save
        </button>
      </div>
    </div>
...
// Reusable Sub-component for the Feature Boxes
